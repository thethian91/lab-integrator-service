# tests/test_icon3_engine.py
import pytest
from app.commons.hl7_engine import HL7Engine
from app.helpers.router import FlowRouter
from app.helpers.tcp_transport import read_mllp_messages, VT, FS, CR
from app.validation.validators import validate_hl7_message_or_raise
import asyncio

TEMPLATE_PATH = "template_reader_orm_hl7.yaml"  # ajusta ruta si es distinta
...
def cfg_min():
    ...
    return {
        "paths": {"logs_root":"logs", "inbox":".", "outbox":".", "archive":"./archive", "error":"./error"},
        "engine": {
...
MLLP_TWO = (
    VT + b"MSH|^~\\&|Icon|ND|LIS|LIS|20250817142000||ORU^R01|A|P|2.5\rOBR|1|A|||||20250817141900|\rOBX|1|NM|HCT^HCT||39.5|^%|35-51|||N|F\r" + FS + CR +
    VT + b"MSH|^~\\&|Icon|ND|LIS|LIS|20250817142005||ORU^R01|B|P|2.5\rOBR|1|B|||||20250817141905|\rOBX|1|NM|RBC^RBC||4.58|^10^12/L|4.1-5.7|||N|F\r" + FS + CR
)
